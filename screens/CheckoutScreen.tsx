      ...
      return (
          <div className="max-w-2xl mx-auto">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 space-y-4 border border-slate-200 dark:border-slate-700">
                  <div>
                      <label className="block text-sm font-medium text-slate-500 dark:text-slate-300 mb-2">Who's Taking This Gear?</label>
                      <input
                          type="text"
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-700 text-slate-900 dark:text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 border border-slate-300 dark:border-slate-600 text-lg"
                      />
                      <datalist id="user-suggestions">
                          {state.users.map((user: User) => <option key={user.id} value={user.name} />)}
                      </datalist>
